...
Promoted from syllable_parser_helpers/character_utils.py.
"""
...
# Import validation sets from stacking rules
...
def is_prefix(char: str) -> bool:
    """Check if character is a valid prefix (ག ད བ མ འ ར)"""
    return char in VALID_PREFIXES


def is_superscript(char: str) -> bool:
    """Check if character is a valid superscript (ར ལ ས)"""
    return char in VALID_SUPERSCRIPTS


def is_post_suffix(char: str) -> bool:
    """Check if character is a valid post-suffix (ད ས)"""
